...
ClapTrap::ClapTrap()
{
    std::cout << "\033[2;30mDefault Constructor called: ClapTrap\033[0m" << std::endl;
    this->Name = "NoName";
    this->HitPoints = 10;
...
{
    std::cout << "\033[2;30mCopy Constructor called: ClapTrap\033[0m" << std::endl;
...
ClapTrap::~ClapTrap()
{
    std::cout << "\033[2;30mDestructor Called: ClapTrap\033[0m" << std::endl;
}

ClapTrap::ClapTrap(std::string Name)
: Name(Name), HitPoints(10), EnergyPoints(10), AttackDamage(0)
{
    std::cout << "\033[2;30mNot Default Constructor called: ClapTrap\033[0m" << std::endl;
}
